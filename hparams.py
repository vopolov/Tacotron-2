...
hparams = tf.contrib.training.HParams(
	...
	tacotron_num_gpus = 0, #Determines the number of gpus in use for Tacotron training.
	wavenet_num_gpus = 0, #Determines the number of gpus in use for WaveNet training.
